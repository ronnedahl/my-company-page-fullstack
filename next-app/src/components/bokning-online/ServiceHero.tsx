    ...
    <section className="py-20 text-center">
      <div className="max-w-[1200px] mx-auto px-5">
        ...
        <h1 className="text-[2rem] sm:text-[2.2rem] md:text-[3rem] font-semibold mb-6 leading-tight">
          Slipp Telefonkrångel <br />
          Låt Kunderna Boka Online
        </h1>
        <p className="max-w-[700px] mx-auto text-[1.1rem] text-gray-text">
          Ett smart bokningssystem som jobbar dygnet runt. Dina kunder väljer
          tid, du får en notis — utan ett enda telefonsamtal.
        </p>
      </div>
    </section>
  );
