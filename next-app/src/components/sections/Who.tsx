...
export default function Who() {
  return (
    <section id="who" className="py-16 sm:py-28">
          ...
          <div className="grid grid-cols-1 md:grid-cols-[1fr_2fr] gap-12 items-center text-left">
            <div className="relative aspect-square max-w-[300px] md:max-w-none mx-auto md:mx-0">
              <Image
                ...
                alt="Peter – webbutvecklare och webbkonsult i Karlstad"
                fill
                className="object-cover rounded-2xl brightness-50 object-[center_25%]"
              />
            </div>
            <div>
              ...
              <p className="text-gray-text mb-5">
                Jag heter Peter och driver Webbkraft från Karlstad. Med en
