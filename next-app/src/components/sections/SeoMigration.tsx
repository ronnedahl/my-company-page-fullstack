...
export default function SeoMigration() {
  return (
    <section className="max-w-[1200px] mx-auto px-5 mb-15">
      <div className="bg-card-bg text-white text-left py-16 px-5 sm:px-12 rounded-[30px]">
        ...
        <p className="max-w-[700px] mb-6 text-gray-text">
        ...
        <p className="max-w-[700px] text-gray-text text-[0.95rem]">
