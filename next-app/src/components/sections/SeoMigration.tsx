...
export default function SeoMigration() {
  return (
    <section className="max-w-[1200px] mx-auto px-5 mb-15">
      <FadeInUp>
        <div className="glass-card text-white text-left py-10 px-5 sm:px-12 rounded-[30px]">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <div>
              <div className="text-3xl mb-4 text-accent-green">
                <FontAwesomeIcon icon={faShieldHalved} />
              </div>
              <h2 className="text-[1.5rem] md:text-[2.2rem] font-semibold mb-5">
              ...
              <p className="text-gray-text text-[0.95rem]">
