...
export default function SeoMigration() {
  return (
    <section className="max-w-[1200px] mx-auto px-5 mb-15">
      <div className="bg-accent-green text-white text-center py-16 px-5 sm:px-12 rounded-[30px]">
        ...
        <p className="max-w-[700px] mx-auto mb-6 opacity-90">
        ...
        <p className="max-w-[700px] mx-auto opacity-80 text-[0.95rem]">
